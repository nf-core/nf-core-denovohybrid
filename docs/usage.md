...
```bash
nextflow run nf-core/denovohybrid --input samplesheet.csv -profile docker
```
...
* `docker`
  ...
  * Pulls software from Docker Hub: [`nfcore/denovohybrid`](https://hub.docker.com/r/nfcore/denovohybrid/)
* `singularity`
